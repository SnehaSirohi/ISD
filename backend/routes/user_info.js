...
const {
    ...
    ScheduledClassReport,ScheduledTestReport,Getuploadassignment, Test_Scheduled, Classes_Scheduled,PostUploadassignment, GetAssignments,classnotification, Assignment_Schedule_student,
